...
collect_s2_posterior_performance <- function(reps = 1:20,
    ...
    for (rep_id in reps) {
        ...
        lambda_df <- data.frame(
            ...
            TT = nrow(lambda_true),
            n1 = ncol(lambda_true),
            gamma_truth_mean = mean(dat$gamma_star %||% NA_real_, na.rm = TRUE),
            gamma_fixed_mean = mean(fit$samples$gamma %||% fit$summary$gamma_fixed_mean %||% NA_real_, na.rm = TRUE),
        ...
        diag_list[[rr]] <- data.frame(
            ...
            gamma_truth_mean = lambda_df$gamma_truth_mean,
            gamma_fixed_mean = lambda_df$gamma_fixed_mean,
            lambda_truth_min = lambda_df$lambda_truth_min,
            lambda_truth_max = lambda_df$lambda_truth_max,
            lambda_post_mean_min = lambda_df$lambda_post_mean_min,
            lambda_post_mean_max = lambda_df$lambda_post_mean_max,
            ...
            log_lambda_rmse = lambda_df$log_lambda_rmse,
            log_lambda_coverage_95 = lambda_df$log_lambda_coverage_95,
            cor_log_lambda = lambda_df$cor_log_lambda,
            cor_delta_log_lambda = lambda_df$cor_delta_log_lambda,
