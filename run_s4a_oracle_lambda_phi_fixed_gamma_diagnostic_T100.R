## ============================================================================
## run_s4a_oracle_lambda_phi_fixed_gamma_diagnostic_T100.R
##
...
##
## Main outputs
##   output_s4a_oracle_lambda_phi_fixed_gamma/
##     S4A_ORACLE_LAMBDA_PHI_FIXED_GAMMA_DIAGNOSTIC_T100/
## ============================================================================

## ---- user settings ----------------------------------------------------------
root_dir <- "."

scenario_id <- "S4A_ORACLE_LAMBDA_PHI_FIXED_GAMMA_DIAGNOSTIC_T100"
...
output_dir <- "output_s4a_oracle_lambda_phi_fixed_gamma"
verbose <- 1000L
overwrite_fit <- TRUE
...
fit_s4a_oracle_lambda_phi_batch <- function(reps = reps_formal,
    ...
    run_info_file <- file.path(out_dir, "run_info_S4A_oracle_lambda_phi_fixed_gamma_diagnostic_T100.rds")
...
s4a_oracle_summary <- fit_s4a_oracle_lambda_phi_batch(
    reps = reps_formal,
    scenario_id_arg = scenario_id,
    data_scenario_id_arg = data_scenario_id,
    data_dir_arg = data_dir,
