## ============================================================================
## run_s4a_sparse_counts_obs_fixed_gamma_T100_v2.R
##
## Scenario 4A sparse-count observation-level stress test with gamma fixed.
##
## Purpose
...
##   The official S4A data keep the Scenario 3 latent spatiotemporal structure
...
s4a_fit_file_unused <- function(rep_id,
    ...
    file.path(
        ...
        output_dir,
        scenario_id,
        sprintf("fit_S4A_sparse_counts_obs_fixed_gamma_rep%02d.rds", as.integer(rep_id))
    )
}
...
s4a_summary_file_unused <- function(rep_id,
    ...
    file.path(
        ...
        output_dir,
        scenario_id,
        sprintf("summary_S4A_sparse_counts_obs_fixed_gamma_rep%02d.csv", as.integer(rep_id))
    )
}
...
fit_s4a_sparse_counts_obs_fixed_gamma_one_rep <- function(rep_id,
    ...
    fit$metadata <- c(
        ...
        list(
            ...
            data_file = dat_file,
            output_dir = output_dir,
            fit_file_prefix = "fit_S4A_sparse_counts_obs_fixed_gamma_rep",
    ...
    if (isTRUE(save_result)) {
        ...
        fit_file <- file.path(out_dir, paste0("fit_S4A_sparse_counts_obs_fixed_gamma_rep", rr, ".rds"))
        csv_file <- file.path(out_dir, paste0("summary_S4A_sparse_counts_obs_fixed_gamma_rep", rr, ".csv"))
...
fit_s4a_sparse_counts_obs_fixed_gamma_batch <- function(reps = 1:10,
    ...
    summary_file <- file.path(out_dir, "summary_S4A_sparse_counts_obs_fixed_gamma_all_reps.csv")
...
fit_files <- file.path(
    fit_dir_full,
    sprintf("fit_S4A_sparse_counts_obs_fixed_gamma_rep%02d.rds", as.integer(reps_formal))
)
...
saveRDS(
    ...
    file.path(fit_dir_full, "run_info_S4A_sparse_counts_obs_fixed_gamma_T100.rds")
)
