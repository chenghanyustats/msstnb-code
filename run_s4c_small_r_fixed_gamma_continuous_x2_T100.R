## ============================================================================
## run_s4c_small_r_fixed_gamma_continuous_x2_T100.R
##
## Scenario 4C strong-overdispersion stress test with continuous-time x2 and gamma fixed.
##
## Purpose
...
##   s4c_small_r_overdispersion_continuous_x2.R
##   data_s4c_overdispersion_continuous_x2/S4C_STRONG_OVERDISPERSION_CONTINUOUS_X2_T100/data_repXX.rds
##
## Main outputs
##   output_s4c_small_r_fixed_gamma_continuous_x2/
##     S4C_STRONG_OVERDISPERSION_FIXED_GAMMA_CONTINUOUS_X2_T100/
##
## Notes
...
s4c_data_file <- "s4c_small_r_overdispersion_continuous_x2.R"
...
output_dir <- "output_s4c_small_r_fixed_gamma_continuous_x2"
verbose <- 1000L
...
continuous_x2_stats_s4c_fit <- function(x2_mat) {
...
check_s4c_source_dataset <- function(data_file,
    ...
    if (exists("validate_s4c_overdispersion_continuous_x2_data", mode = "function")) {
    ...
    x2_stats <- continuous_x2_stats_s4c_fit(dat$x2)
...
fit_s4c_small_r_fixed_gamma_one_rep <- function(rep_id,
    ...
    cat(sprintf("=== Scenario 4C strong-overdispersion continuous-time x2 fixed-gamma fit: rep %s ===\n", rr))
    ...
    x2_extra <- continuous_x2_stats_s4c_fit(dat$x2)
    ...
    fit$metadata <- c(
        ...
        list(
            ...
            fit_file_prefix = "fit_S4C_small_r_fixed_gamma_continuous_x2_rep",
    ...
    if (isTRUE(save_result)) {
        ...
        fit_file <- file.path(out_dir, paste0("fit_S4C_small_r_fixed_gamma_continuous_x2_rep", rr, ".rds"))
        csv_file <- file.path(out_dir, paste0("summary_S4C_small_r_fixed_gamma_continuous_x2_rep", rr, ".csv"))
...
fit_s4c_small_r_fixed_gamma_batch <- function(reps = 1:10,
    ...
    summary_file <- file.path(out_dir, "summary_S4C_small_r_fixed_gamma_continuous_x2_all_reps.csv")
...
print(source_data_manifest[, c(
    ...
    "kappa_cv", "reference_kappa_cv", "x2_mode", "x2_ar", "x2_innov_sd", "x2_empirical_ar1_mean",
...
fit_files <- file.path(
    fit_dir_full,
    sprintf("fit_S4C_small_r_fixed_gamma_continuous_x2_rep%02d.rds", as.integer(reps_formal))
)
...
saveRDS(
    ...
    file.path(fit_dir_full, "run_info_S4C_small_r_fixed_gamma_continuous_x2_T100.rds")
)
...
cat("\nScenario 4C strong-overdispersion continuous-time x2 fixed-gamma T100 fitting finished successfully.\n")
